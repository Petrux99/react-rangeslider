  ...
  function Slider(props, context) {
    ...
    _this.handleStart = function (e) {
      ...
      if (e.screenX !== undefined) {
        // Otherwise not mousedown, probably touchstart
        _this.mouseDownCoords = { x: e.screenX, y: e.screenY };
      }
    ...
    _this.handleDrag = function (e) {
      ...
      if (_this.mouseDownCoords && e.screenX === _this.mouseDownCoords.x && e.screenY === _this.mouseDownCoords.y) {
        return;
      }
      _this.mouseDownCoords = undefined;
